...
var selfTest = 'http://192.168.0.185:8090';
//var selfTest = 'http://112.74.198.2:8090';
module.exports = {
    ...
    GetPackage: selfTest + '/order/v1/getPackage', //获取套餐
    GetCardNo: selfTest + '/card/v1/getcard', //获取卡片信息

    packageOrder: selfTest + '/wx/order/packageOrder', //订购套餐并支付

    login: selfTest + '/wx/auth/login', //账号登录
