  ...
  methods: {
    ...
    recoverNet() {
      ...
      if (
        ...
        $.confirm(
          "25号以后恢复上网需订购次月套餐，</br>订购后最迟一小时后恢复上网，若是还不能使用请联系客服，客服回复7就好。",
          "注意",
          function() {
            $.showLoading();
    ...
    unbindCard() {
      const _this = this;
      $.confirm(
        "10天内只允许解绑一次！</br>系统会在30分钟内重置机卡绑定信息,</br><span style='color: red'>申请解绑30分钟后请重启一下设备。</span>",
        "注意",
        function() {
          $.showLoading();
    ...
    loadmore(loaded) {
      ...
      if (_this.recover_flag != 1 && _this.$route.query.type != 2) {
        c.$post(
          "?r=wms/personal/get-card-simstate",
          {
            pageSize: 10,
          ...
          function(res) {
            ...
            if (res.code == 1) {
              ...
              _this.recover = Object.assign(
                Object.values(_this.recover).concat(res.data.rows)
              );
            }
          }
        );
        ...
        c.$post(
          ...
          function(res) {
            ...
            if (res.code == 1) {
              ...
              _this.unbind = Object.assign(
                Object.values(_this.unbind).concat(res.data.rows)
              );
            }
          }
        );
    ...
    c.$get(
      ...
      function(res) {
        ...
        if (
          ...
          if (
            res.data.card_status == "停机" ||
            res.data.card_status == "停机,停机保号"
          ) {
            _this.status = "断网";
            _this.type = "2";
          } else {
