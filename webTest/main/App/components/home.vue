<template>
  <div class="TotalContentBox">
    ...
    <div class="weui-cell weui-cell_link " style="text-align: center;padding: 5px 15px;" @click="showMore">
      <div class="weui-cell__bd">{{showMoreStatus==true?'收起':'查看更多'}} <img src="../img/arrow.png" alt="" style="width: 10px;vertical-align: middle"></div>
    </div>
      ...
      <div class="weui-panel__bd">
        <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg" @click="freeCard">
          ...
          <div class="weui-media-box__bd">
            <h4 class="weui-media-box__title " style="color: orangered">4G无线上网设备免费领</h4>
            <p class="weui-media-box__desc">为了能让用户更方便的使用物联网卡，给用户带来更好的急速上网体验，我们现在4G无线上网卡免费送。</p>
          </div>
        </a>
      </div>
    </div>
  ...
  methods: {
    ...
    orderList: function() {
      ...
      window.location.href =
        "http://wx.szcoolfish.com/coolfish/tpl/main/extend/cardList.html";
    },
    diagnose: function() {
    ...
    freeCard: function() {
      if (sessionStorage.getItem("MicroMessenger") == "true") {
        this.$router.push({ path: "view", query: { id: 80 } });
      } else {
