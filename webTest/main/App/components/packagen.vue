<template>
  <div class="weui-tab body-margin">
    ...
    <div class="weui-tab__bd " id="template">
      <div class="weui-tab__bd-item " v-bind:class="[index==0 ? 'weui-tab__bd-item--active' : '']" v-for="(item,key, index) in libArr" v-bind:id="key" v-if="item.length>0">
        <div class="weui-panel weui-panel_access" v-if="libArr.tab5.length>0">
          <div class="weui-panel__hd package_title title_one" v-bind:class="[libArr.tab5.length>0 ? '' : 'hidden']">推荐套餐：
          </div>
          <div class="weui-panel__bd " v-for="tab1 in libArr.tab5">
            <div class="weui-media-box weui-media-box_appmsg package_content" style="height: auto;" @click="active(key, index)">
              ...
              <div class="weui-media-box__bd" style="height: auto;">
                ...
                <div class="weui-media-box__desc" v-if="tab1.is_infinite == '2'" style="font-size:12px ; display: block">
                  {{tab1.text}}
                </div>
        ...
        <div class="weui-panel weui-panel_access margin">
          ...
          <div class="weui-panel__bd " v-for="(tab1, index) in item">
            <div href="" class="weui-media-box weui-media-box_appmsg package_content" style="height: auto;" @click="active(key, index)" v-bind:class="[tab1.active==true ? 'active' : '']">
...
export default {
  ...
  methods: {
    ...
    addType: function() {
      ...
      c.$get2("http://120.77.253.165:8090/common/v1/gettime", function(res) {
