<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model.trim="listQuery.name" class="filter-item" style="width:220px" clearable placeholder="请输入名称" @keyup.enter.native="handleFilter"/>
...
export default {
  ...
  value(dialogOpenFormVisible) {
    if (dialogOpenFormVisible === 'false') {
      this.sec.nickname = ''
    }
  },
  created() {
