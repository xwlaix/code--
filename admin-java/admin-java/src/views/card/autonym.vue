<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-show="secMore" v-model.trim="listQuery.cardNo" class="filter-item" style="width:220px" clearable placeholder="请输入身份证号码" @keyup.enter.native="handleFilter"/>
      <el-input v-show="secMore" v-model.trim="listQuery.tel" class="filter-item" style="width:220px" clearable placeholder="请输入ICCID或者接入号" @keyup.enter.native="handleFilter"/>
      <el-input v-show="secMore" v-model.trim="listQuery.name" class="filter-item" style="width:220px" clearable placeholder="请输入姓名" @keyup.enter.native="handleFilter"/>
      <el-input v-show="secMore" v-model.trim="listQuery.phone" class="filter-item" style="width:220px" clearable placeholder="请输入电话" @keyup.enter.native="handleFilter"/>
      <el-date-picker
        v-show="secMore"
