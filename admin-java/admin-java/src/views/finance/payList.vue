  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-date-picker
        ...
        class="filter-item"
      />
      <el-input v-model.trim="listQuery.nickname" clearable class="filter-item" style="width: 200px;" placeholder="请输入昵称" @keyup.enter.native="handleFilter"/>
...
export default {
  ...
  methods: {
    jump() {
      this.$router.push(`/finance/weipayRefund`)
    },
    approvalRefund(row) {
