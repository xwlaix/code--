<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model.trim="listQuery.headname" class="filter-item" style="width:220px" clearable placeholder="请输入负责人" @keyup.enter.native="handleFilter"/>
      <el-input v-model.trim="listQuery.name" class="filter-item" style="width:220px" clearable placeholder="请输入网点名称" @keyup.enter.native="handleFilter"/>
      <el-input v-model.trim="listQuery.address" class="filter-item" style="width:220px" clearable placeholder="请输入地址" @keyup.enter.native="handleFilter"/>
