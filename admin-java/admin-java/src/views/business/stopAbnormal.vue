<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-waves v-permission="['kuyuplat:cardActionException:export']" class="filter-item" size="small" type="warning " icon="el-icon-download" @click="webDownload"/>
    </div>
...
import { searchCardActionException, exportCardActionException } from '@/api/stopReset'
...
export default {
  ...
  methods: {
    ...
    webDownload() {
      ...
      exportCardActionException(this.listQuery, '.filter-container').then(res => {
        if (+res.status === 0) {
