<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-show="secMore" v-model.trim="listQuery.oldCard" clearable style="width: 200px;" class="filter-item" placeholder="请输入原卡号" @keyup.enter.native="handleFilter"/>
      <el-input v-show="secMore" v-model.trim="listQuery.newCard" clearable style="width: 200px;" class="filter-item" placeholder="请输入iccid" @keyup.enter.native="handleFilter"/>
      <el-date-picker
        v-show="secMore"
      ...
      <el-button v-waves v-show="secMore" size="small" type="primary" class="filter-item" icon="el-icon-search" @click="handleFilter" @keyup.enter.native="handleFilter"/>
