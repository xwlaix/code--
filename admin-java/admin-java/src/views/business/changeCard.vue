<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model.trim="listQuery.oldcard" class="filter-item" style="width:220px" clearable placeholder="请输入原卡号" @keyup.enter.native="handleFilter"/>
      <el-input v-model.trim="listQuery.newcard" class="filter-item" style="width:220px" clearable placeholder="请输入现ICCID" @keyup.enter.native="handleFilter"/>
      <el-input v-model.trim="listQuery.uname" class="filter-item" style="width:220px" clearable placeholder="请输入姓名" @keyup.enter.native="handleFilter"/>
      ...
      <el-date-picker
        ...
        class="filter-item"
      />
      <el-input v-model.trim="listQuery.phone" class="filter-item" style="width:220px" clearable placeholder="请输入手机号码" @keyup.enter.native="handleFilter"/>
