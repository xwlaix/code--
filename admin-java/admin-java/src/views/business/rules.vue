<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model.trim="listQuery.name" class="filter-item" style="width:150px" clearable placeholder="请输入名称" @clear="handleRefresh" @keyup.enter.native="handleFilter"/>
