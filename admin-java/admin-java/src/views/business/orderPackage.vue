<template>
  ...
  >
    <div v-if="source!='mobile'" class="filter-container">
      ...
      <el-button v-waves size="small" type="primary" class="filter-item secCard" icon="el-icon-search" @click="handleFilter" @keyup.enter.native="handleFilter"/>
    ...
    <el-table
      ...
      <el-table-column show-overflow-tooltip align="center" label="供应商账号" min-width="160">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="来源" width="160">
        <template slot-scope="scope">
          <el-popover v-if="scope.row.source" trigger="hover" placement="top">
            <p>{{ scope.row.source |filterFun }}</p>
            <div slot="reference">
      ...
      <el-table-column align="center" label="消息" width="150">
        <template slot-scope="scope">
