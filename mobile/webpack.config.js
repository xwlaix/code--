...
var entries = function() {
    ...
    //     vendors: ['babel-polyfill', 'vue', 'vue-router', 'vuex']
    // };
    return map;
}
...
var html_plugins = function() {
    ...
    for (var i = 0; i < entryHtml.length; i++) {
        ...
        if (filename in entriesFiles) {
            conf.inject = 'true'
            conf.chunks = ['index','vendors', 'manifest', filename]
        }
...
module.exports = function(env) {
    ...
    var rules = [
        ...
        {
            test: /\.css$/,
            use: SETTINGS.isDebug ? ['style-loader', 'css-loader'] : ExtractTextPlugin.extract({
    ...
    if (SETTINGS.isDebug) {
        ...
        plugins.push(new OpenBrowserPlugin({
            url: 'http://localhost:' + SETTINGS.visitPort + SETTINGS.path.publicPath + 'mobileLogin.html'
        }));
        devServer = {
