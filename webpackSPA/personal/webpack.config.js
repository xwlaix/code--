...
var resolve = {
    ...
    alias: {
         ...
         * js
         */
        jquery: path.join(PATHS.libsPath, "js/jquery/jquery-3.1.1.min.js"),
...
var entry = {
    ...
    common: [
        path.join(PATHS.libsPath, "js/jquery/jquery-3.1.1.min.js"),
...
var plugins = [
     ...
     * （公共js）
     * */
    new webpack.optimize.CommonsChunkPlugin(devServer ? {
        name: "common",
    ...
    new HtmlWebpackPlugin({
        filename: 'bindCard.html',
        template: __dirname + '/src/bindCard.html',
        /*
    ...
    config = Merge(config, {
        plugins: [
            ...
            new OpenBrowserPlugin({
                url: 'http://localhost:8080' + PATHS.publicPath + 'bindCard.html'
            })
        ],
        devServer: {
