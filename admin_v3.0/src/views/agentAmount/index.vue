<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-permission="['account.wx.recharge']" v-waves size="small" type="warning" class="filter-item" @click="recharge" >充值</el-button>
    ...
    <p v-permission="['account.money']" class="warn-content " style="margin : 0">
      账户余额:<a>{{ money }}</a>
    </p>
    <el-table
      :data="list"
